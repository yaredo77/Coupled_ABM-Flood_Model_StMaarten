...
iii.	Flood hazard reduction: the following sub-processes run in order – select catchment where flood hazard reduction measure is implemented, update flood model hydraulic input files (see *ABMFloodModelcouple.java* under the *operationalStructure* package). All the sub-processes run if there is flood causing rainfall in a given time step.

![flowchart](https://user-images.githubusercontent.com/13009562/44588511-36cb9c00-a7b6-11e8-8721-80ace0a687c8.jpg)
Figure 1. Coupled ABM-flood model implementation flowchart for the Sint Maarten flood risk management.
